...
<?php 
      require_once "db.php";
       if(isset($_REQUEST["update"]))
       {
              ...
              $sql = "update  individaul set ind_type='$type',ind_add='$add',
              ind_rent='rent',property_id = '$pid'where ind_id=$iid";
              ...
              if($res == 1)
              {
                   ...
                   echo "<script>alert('Individual  Updated');</script>";
       ...
       $sql = "select * from individaul where ind_id = $id";
