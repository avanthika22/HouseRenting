...
<?php 
      require_once "db.php";
       if(isset($_REQUEST["update"]))
       {
              ...
              $sql = "update  apartment set a_type='$type',a_add='$add',
              a_rent='rent',pid = '$pid'where a_id=$iid";
              ...
              if($res == 1)
              {
                   ...
                   echo "<script>alert('Apartment  Updated');</script>";
       ...
       $sql = "select * from apartment where a_id = $id";
