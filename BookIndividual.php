 ...
 require_once "db.php";
       if(isset($_REQUEST["Add"]))
       {
        ...
        if (is_uploaded_file($_FILES['image']['tmp_name'])) {
         ...
         $sql = "INSERT INTO application_form(application_name,id_proff,imgType,vtype,application_mail,password,application_mobile,application_gender,leasing,payment,iid,status) 
         values (?,?,?,?,?,?,?,?,?,?,?,?)";
